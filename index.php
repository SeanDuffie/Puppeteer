 ...
 */
    ...
    } else if (array_key_exists("Config", $_POST)) {
        echo getPin($URL, "config");
    ...
    echo "\t<form method='post'>
        ...
        <p>
            <label class='switch switch-slide'>
                <input class='switch-input' type='submit' name='$output0' value='$output0State'/>
        ...
        <p>
            <label class='switch switch-slide'>
                <input class='switch-input' type='submit' name='$output1' value='$output1State'/>
                <span class='switch-label' data-on='ON' data-off='OFF'></span>
                <span class='switch-handle'></span>
            </label>
        </p>
        ...
        <p>
            <label class='switch switch-slide'>
                <input class='switch-input' type='submit' name='$output2' value='$output2State'/>
                <span class='switch-label' data-on='ON' data-off='OFF'></span>
                <span class='switch-handle'></span>
            </label>
        </p>
        ...
        <p>
            <label class='switch switch-slide'>
                <input class='switch-input' type='submit' name='$output3' value='$output3State'/>
                <span class='switch-label' data-on='ON' data-off='OFF'></span>
                <span class='switch-handle'></span>
            </label>
        </p>
        <p>Open Config Menu</p>
        <p>
            <label class='switch switch-slide'>
                <input class='switch-input' type='submit' name='Config' value='Config'/>
                <span class='switch-label' data-on='ON' data-off='OFF'></span>
                <span class='switch-handle'></span>
            </label>
        </p>
        <p>Reset Wifi Config</p>
        <p>
            <label class='switch switch-slide'>
                <input class='switch-input' type='submit' name='Reset' value='Reset'/>
                <span class='switch-label' data-on='ON' data-off='OFF'></span>
                <span class='switch-handle'></span>
            </label>
        </p>
